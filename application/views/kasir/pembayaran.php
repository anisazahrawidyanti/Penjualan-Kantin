            ...
            <?php foreach($orders as $order) : ?>
                ...
                <form action="<?php echo base_url().'kasir/data_transaksi/simpan_transaksi'?>" method="post" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" name="total_harga" class="form-control" id="total" value="<?php echo $order->total_harga?>" readonly>
                    </div>
                    <div class="form-group">
                        <label for="">Total Uang</label>
                        <input type="number" name="total_uang" class="form-control" id="uang" onkeyup="kembalian()">
                    </div>
                    <div class="form-group">
                        <label for="">Total Kembalian</label>
                        <input type="number" name="total_kembali" class="form-control" id="kmbli"  readonly>
                    </div>
...
<script type="text/javascript">
    function kembalian() { 
      var uangs  = Number(document.getElementById("uang").value);
      var totals = Number(document.getElementById("total").value);
      var kembali = uangs - totals;
      Number(document.getElementById("kmbli").value = kembali);
