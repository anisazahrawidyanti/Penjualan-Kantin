            ...
            <?php foreach($transaksi as $trans) : ?>
                ...
                <form method="post" action="<?php echo base_url().'kasir/data_transaksi/update' ?>">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="total_uang" class="form-control" value="<?php echo $trans->total_uang?>">
                    </div>
                    <div class="form-group">
                        <label for="">Total Kembali</label>
                        <input type="text" name="total_kembali" class="form-control" value="<?php echo $trans->total_kembali?>">
                    </div>
